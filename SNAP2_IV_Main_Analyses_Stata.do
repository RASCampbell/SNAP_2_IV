* Stata Do file to run the IV analysis for POMS estimate with postoperative CCU admission.   
...
export excel using "CCU_IV_POMS_pars_mv_impute_norm_age_cat.xlsx", sheet("raw") sheetreplace firstrow(varlabels)
...
* export excel sheet with results
export excel using "2SLS_IV_POMS_pars_mv_impute_norm_age_cat.xlsx", sheet("raw") sheetreplace firstrow(varlabels)
