* Stata Do file to run the IV analysis for POMS estimate with postoperative CCU admission, for the Complete Case Sensitvity Analysis  
...
use complete_case_data_poms, clear
...
export excel using "CCU_IV_POMS_pars_mv.xlsx", sheet("raw") sheetreplace firstrow(varlabels)
...
* export excel sheet with results
export excel using "2SLS_IV_POMS_pars_mv.xlsx", sheet("raw") sheetreplace firstrow(varlabels)
