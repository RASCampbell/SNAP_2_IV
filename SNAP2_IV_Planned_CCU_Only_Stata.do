* Stata Do file to run the IV analysis for POMS estimate with postoperative CCU admission, for the Planned CCU Admission Only Sensitvity Analysis  
...
use planned_icu_only_imputed_dta, clear
...
export excel using "CCU_IV_POMS_planned_icu_only_imputed.xlsx", sheet("raw") sheetreplace firstrow(varlabels)
...
* export excel sheet with results
export excel using "2SLS_IV_POMS_planned_icu_only_imputed.xlsx", sheet("raw") sheetreplace firstrow(varlabels)
