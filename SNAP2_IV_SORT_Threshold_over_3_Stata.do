* Stata Do file to run the IV analysis for POMS estimate with postoperative CCU admission, for the SORT Threshold Sensitvity Analysis (>3%)
...
use patients_labelled6_imputed_sort3_over, clear
...
export excel using "CCU_IV_sort_3+_pars_mv.xlsx", sheet("raw") sheetreplace firstrow(varlabels)
...
* export excel sheet with results
export excel using "2SLS_CCU_IV_sort_3+_pars_mv.xlsx", sheet("raw") sheetreplace firstrow(varlabels)
